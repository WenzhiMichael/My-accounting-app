...
export const translations = {
    en: {
        ...
        // Category Groups
        group_food: 'Food & Dining',
        group_transport: 'Transport',
        group_shopping: 'Shopping',
        group_housing: 'Housing',
        group_entertainment: 'Entertainment',
        group_medical: 'Medical & Education',
        group_social: 'Social & Others',
        group_others: 'Others',
        group_income: 'Income',

        // Categories
        cat_dining: 'Dining',
        cat_breakfast_lunch_dinner: 'Meals',
        cat_drinks_fruits: 'Drinks & Fruits',
        cat_snacks: 'Snacks',
        cat_vegetables: 'Groceries',
        cat_takeout: 'Takeout',

        cat_public_transport: 'Public Transport',
        cat_taxi: 'Taxi/Rideshare',
        cat_car: 'Private Car',
        cat_bike_sharing: 'Bike Share',
        cat_long_distance: 'Long Distance',

        cat_clothing: 'Clothing',
        cat_beauty: 'Beauty',
        cat_daily_supplies: 'Daily Supplies',
        cat_electronics: 'Electronics',
        cat_furniture: 'Furniture',
        cat_virtual: 'Virtual Goods',

        cat_rent: 'Rent/Mortgage',
        cat_utilities: 'Utilities',
        cat_property_fee: 'Property Fee',
        cat_internet: 'Internet/Phone',
        cat_maintenance: 'Maintenance',

        cat_party: 'Party',
        cat_movies: 'Movies/Events',
        cat_fitness: 'Fitness',
        ...
        cat_gifts: 'Gifts',
        cat_red_packet: 'Red Packet',
        cat_family: 'Family',
        cat_loan_out: 'Lending',
        cat_donation: 'Donation',
        cat_pets: 'Pets',
        cat_lost: 'Lost',
        cat_fees: 'Fees',
        ...
        cat_salary: 'Salary',
        cat_bonus: 'Bonus',
        cat_side_job: 'Side Job',
        cat_investment: 'Investment',
        cat_gift_money: 'Gift Money',
        cat_refund: 'Refund',
        cat_borrow: 'Borrowing',
    },
    zh: {
        // Navigation & Common
        home: '首页',
        ...
        // Category Groups
        group_food: '餐饮美食',
        group_transport: '交通出行',
        group_shopping: '购物消费',
        group_housing: '居住缴费',
        group_entertainment: '休闲娱乐',
        group_medical: '医疗教育',
        group_social: '人情往来',
        group_others: '其他',
        group_income: '收入',
        ...
        // Categories
        cat_dining: '餐饮美食',
        cat_breakfast_lunch_dinner: '早餐/午餐/晚餐',
        cat_drinks_fruits: '饮料水果',
        cat_snacks: '零食烟酒',
        cat_vegetables: '买菜食材',
        cat_takeout: '外卖',

        cat_public_transport: '公共交通',
        cat_taxi: '打车/网约车',
        cat_car: '私家车',
        cat_bike_sharing: '共享单车',
        cat_long_distance: '长途出行',

        cat_clothing: '服饰鞋包',
        cat_beauty: '护肤美妆',
        cat_daily_supplies: '日用百货',
        ...
        cat_rent: '房租/房贷',
        cat_utilities: '水电燃气',
        cat_property_fee: '物业费',
        cat_internet: '通讯网费',
        cat_maintenance: '维修家政',
